...
/**
 * Purpose:
 * Loads a sample CSV into a DataSet, filters by year/month, runs the HeatRiskAnalyzer to compute a summary, and prints results
 */
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("Avg HI: %.1f  Max HI: %.1f%n", s.averageHeatIndex, s.maxHeatIndex);
