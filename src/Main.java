...
// Optional console test runner (GUI is the main program).
public class Main
{
	public static void main(String[] args) throws Exception
	{
		// Update this path if you want to run Main instead of the GUI
		DataSet dataSet = DataSet.loadFromCsv(Path.of(
				"C:\\Users\\byron\\OneDrive\\Desktop\\CISC-191-Intermediate-Java-Project\\src\\sample_weather.csv"));
		...
		System.out.println("Loaded records: " + dataSet.all().size()
				+ " (skipped: " + dataSet.getSkippedRowCount() + ")");
