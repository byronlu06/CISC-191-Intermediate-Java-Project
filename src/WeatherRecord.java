 ...
 * Provides methods to calculate the Heat Index and determine if the day
 * qualifies as a heat day based on a temperature threshold.
 */

import java.time.LocalDate;

// One day of weather data from the CSV.
public class WeatherRecord
{
	...
	public WeatherRecord(LocalDate date, double maxTemp, double minTemp,
	...
	// Estimates heat index from max temp + humidity.
	...
	// True if heat index meets/exceeds the threshold.
